...
pub use malachite::Integer as BigInt;

pub fn bigint_from_str_radix(s: &str, radix: i32) -> Option<BigInt> {
    Integer::from_string_base(radix as u8, s)
}

pub fn bigint_count_ones(v: &BigInt) -> Option<u64> {
    v.checked_count_ones()
}
...
impl Shr<u32> for BitVec {
    ...
    fn shr(self, rhs: u32) -> Self::Output {
        ...
        if (rhs as usize) >= size {
            ...
            let mask = smask ^ ((BigInt::from(1) << (size - rhs as usize) as u32) - BigInt::from(1));
